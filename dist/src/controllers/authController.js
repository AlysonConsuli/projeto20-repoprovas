...
export var signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.body;
                return [4 /*yield*/, authService.signin(user)];
            case 1:
                token = _a.sent();
...
export var logout = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                token = res.locals.token;
                return [4 /*yield*/, authService.logout({ token: token })];
            case 1:
                _a.sent();
                res.sendStatus(200);
                return [2 /*return*/];
